...
--
-- Servidor: localhost
-- Tiempo de generación: 29-07-2019 a las 01:40:55
...
--
-- Base de datos: `asignacioncursos`
--
CREATE DATABASE `asignacioncursos` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
...
CREATE TABLE IF NOT EXISTS `asignacion` (
  ...
  `cFecha` varchar(45) DEFAULT NULL,
  `iIdEstudiantes` int(11) NOT NULL,
  `iIdCarrera` int(11) NOT NULL,
  PRIMARY KEY (`idAsignacion`),
  KEY `fk_Asignacion_Alumnos1` (`iIdEstudiantes`),
  KEY `fk_Asignacion_Carrera1` (`iIdCarrera`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `asignacioncurso`
--

CREATE TABLE IF NOT EXISTS `asignacioncurso` (
  `iIdAsignacionCurso` int(11) NOT NULL,
  `cDescripcion` varchar(45) DEFAULT NULL,
  `cFecha` varchar(45) DEFAULT NULL,
  `iIdCatedratico` int(11) NOT NULL,
  PRIMARY KEY (`iIdAsignacionCurso`),
  KEY `fk_AsignacionCurso_Catedratico1` (`iIdCatedratico`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `asignacioncursodetalle`
--

CREATE TABLE IF NOT EXISTS `asignacioncursodetalle` (
  `iIdAsignacionCursoDetalle` int(11) NOT NULL,
  `cDescripcion` varchar(45) DEFAULT NULL,
  `iIdAsignacionCurso` int(11) NOT NULL,
  `iIdCurso` int(11) NOT NULL,
  `iIdJornada` int(11) NOT NULL,
  `iIdSemestre` int(11) NOT NULL,
  `iIdSeccion` int(11) NOT NULL,
  `iIdFacultad` int(11) NOT NULL,
  PRIMARY KEY (`iIdAsignacionCursoDetalle`),
  KEY `fk_AsignacionCursoDetalle_AsignacionCurso1` (`iIdAsignacionCurso`),
  KEY `fk_AsignacionCursoDetalle_Curso1` (`iIdCurso`),
  KEY `fk_AsignacionCursoDetalle_Jornada1` (`iIdJornada`),
  KEY `fk_AsignacionCursoDetalle_Semestre1` (`iIdSemestre`),
  KEY `fk_AsignacionCursoDetalle_Seccion1` (`iIdSeccion`),
  KEY `fk_AsignacionCursoDetalle_Facultad1` (`iIdFacultad`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `asignaciondetalle` (
  `iIdAsignacionDetalle` int(11) NOT NULL,
  `cDescripcion` varchar(45) DEFAULT NULL,
  `cFecha` varchar(45) DEFAULT NULL,
  `iIdCurso` int(11) NOT NULL,
  `iIdHorario` int(11) NOT NULL,
  `iIdSeccion` int(11) NOT NULL,
  `iIdLaboratorio` int(11) NOT NULL,
  `iIdSemestre` int(11) NOT NULL,
  `iIdAsignacion` int(11) NOT NULL,
  PRIMARY KEY (`iIdAsignacionDetalle`),
  KEY `fk_AsignacionDetalle_Curso1` (`iIdCurso`),
  KEY `fk_AsignacionDetalle_Horario1` (`iIdHorario`),
  KEY `fk_AsignacionDetalle_Seccion1` (`iIdSeccion`),
  KEY `fk_AsignacionDetalle_Laboratorio1` (`iIdLaboratorio`),
  KEY `fk_AsignacionDetalle_Semestre1` (`iIdSemestre`),
  KEY `fk_AsignacionDetalle_Asignacion1` (`iIdAsignacion`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `asignacionlista`
--

CREATE TABLE IF NOT EXISTS `asignacionlista` (
  `iIdAsignacionLista` int(11) NOT NULL,
  `cDescripcion` varchar(45) DEFAULT NULL,
  `cFecha` varchar(45) DEFAULT NULL,
  `bValidado` tinyint(4) DEFAULT NULL,
  `iIdJornada` int(11) NOT NULL,
  `iIdSemestre` int(11) NOT NULL,
  `iIdCurso` int(11) NOT NULL,
  `iIIdSeccion` int(11) NOT NULL,
  `iIdCatedratico` int(11) NOT NULL,
  PRIMARY KEY (`iIdAsignacionLista`),
  KEY `fk_AsignacionLista_Jornada1` (`iIdJornada`),
  KEY `fk_AsignacionLista_Semestre1` (`iIdSemestre`),
  KEY `fk_AsignacionLista_Curso1` (`iIdCurso`),
  KEY `fk_AsignacionLista_Seccion1` (`iIIdSeccion`),
  KEY `fk_AsignacionLista_Catedratico1` (`iIdCatedratico`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `asignacionlistadetalle`
--

CREATE TABLE IF NOT EXISTS `asignacionlistadetalle` (
  `iIdAsignacionListaDetalle` int(11) NOT NULL,
  `cDescripcion` varchar(45) DEFAULT NULL,
  `cStatus` varchar(45) DEFAULT NULL,
  `cNota` varchar(45) DEFAULT NULL,
  `iIdAsignacionLista` int(11) NOT NULL,
  `iIdAlumnos` int(11) NOT NULL,
  PRIMARY KEY (`iIdAsignacionListaDetalle`),
  KEY `fk_AsignacionListaDetalle_AsignacionLista1` (`iIdAsignacionLista`),
  KEY `fk_AsignacionListaDetalle_Alumnos1` (`iIdAlumnos`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `bitacora` (
  ...
  `fecho_cierre` varchar(45) DEFAULT NULL,
  `accion` varchar(45) DEFAULT NULL,
  `ip` varchar(45) DEFAULT NULL,
  `mac` varchar(45) DEFAULT NULL,
  `nombrePC` varchar(45) DEFAULT NULL,
  `iIdUsuarios` int(11) NOT NULL,
  PRIMARY KEY (`idBitacora`),
  KEY `fk_Bitacora_Usuarios1` (`iIdUsuarios`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `carrera` (
  `iIdCarrera` int(11) NOT NULL,
  `cNombre` varchar(45) DEFAULT NULL,
  `iIdFacultad` int(11) NOT NULL,
  PRIMARY KEY (`iIdCarrera`),
  KEY `fk_Carrera_Facultad1` (`iIdFacultad`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `certificacion` (
  `iIdCertificacion` int(11) NOT NULL,
  `cDescripcion` varchar(45) DEFAULT NULL,
  `cFecha` varchar(45) DEFAULT NULL,
  `iIdAlumnos` int(11) NOT NULL,
  PRIMARY KEY (`iIdCertificacion`),
  KEY `fk_Certificacion_Alumnos1` (`iIdAlumnos`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla `certificaciondetalle`
--

CREATE TABLE IF NOT EXISTS `certificaciondetalle` (
  `iIdCertificacionDetalle` int(11) NOT NULL,
  `cDescripcion` varchar(45) DEFAULT NULL,
  `iNota` int(11) DEFAULT NULL,
  `iIdCertificacion` int(11) NOT NULL,
  `iIdCurso` int(11) NOT NULL,
  PRIMARY KEY (`iIdCertificacionDetalle`),
  KEY `fk_CertificacionDetalle_Certificacion1` (`iIdCertificacion`),
  KEY `fk_CertificacionDetalle_Curso1` (`iIdCurso`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `detallepensum` (
  `iIdPensum` int(11) NOT NULL,
  `iIdCurso` int(11) NOT NULL,
  `cDescripcion` varchar(45) DEFAULT NULL,
  PRIMARY KEY (`iIdPensum`,`iIdCurso`),
  KEY `fk_DetallePensum_Curso1` (`iIdCurso`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `edificio` (
  `iIdEdificio` int(11) NOT NULL,
  `cNombre` varchar(45) DEFAULT NULL,
  `iIdFacultad` int(11) NOT NULL,
  `iIdSalon` int(11) NOT NULL,
  PRIMARY KEY (`iIdEdificio`),
  KEY `fk_Edificio_Facultad1` (`iIdFacultad`),
  KEY `fk_Edificio_Salon1` (`iIdSalon`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `estudiantes` (
  `iIdEstudiantes` int(11) NOT NULL,
  `cNombres` varchar(45) DEFAULT NULL,
  `cApellidos` varchar(45) DEFAULT NULL,
  `iEdad` int(11) DEFAULT NULL,
  `cDireccion` varchar(45) DEFAULT NULL,
  `cEmail` varchar(45) DEFAULT NULL,
  `cTelefono` varchar(8) DEFAULT NULL,
  `cGenero` varchar(20) DEFAULT NULL,
...
INSERT INTO `facultad` (`iIdFacultad`, `cNombre`) VALUES
(1, 'Ingenieria'),
(2, 'Administracion');
...
CREATE TABLE IF NOT EXISTS `horario` (
  `iIdHorario` int(11) NOT NULL,
  `cDuracion` varchar(45) DEFAULT NULL,
  `cHoraInicio` varchar(45) DEFAULT NULL,
  `cHoraFinal` varchar(45) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `laboratorio` (
  ...
  KEY `fk_Laboratorio_Salon1` (`iIdSalon`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `pensum` (
  `iIdPensum` int(11) NOT NULL,
  `cDescripcion` varchar(45) DEFAULT NULL,
  `cFecha` varchar(10) DEFAULT NULL,
  `cCreditos` varchar(45) DEFAULT NULL,
  `iIdJornada` int(11) NOT NULL,
  `idCarrera` int(11) NOT NULL,
  PRIMARY KEY (`iIdPensum`),
  KEY `fk_Pensum_Jornada1` (`iIdJornada`),
  KEY `fk_Pensum_Carrera1` (`idCarrera`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE IF NOT EXISTS `salon` (
  `iIdSalon` int(11) NOT NULL,
  `cNoSalon` varchar(10) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS `seccion` (
  `iIdSeccion` int(11) NOT NULL,
  `cDescripcion` varchar(45) DEFAULT NULL,
  `cCapacidad` varchar(45) DEFAULT NULL,
  `iIdSalon` int(11) NOT NULL,
  PRIMARY KEY (`iIdSeccion`),
  KEY `fk_Seccion_Salon1` (`iIdSalon`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `tipo` (`iIdTipo`, `cDescripcion`) VALUES
(1, 'Administrador'),
(2, 'Catedratico'),
(3, 'Estudiante');
...
CREATE TABLE IF NOT EXISTS `usuarios` (
  ...
  `bPassword` varchar(50) DEFAULT NULL,
  `bUsuario` varchar(50) DEFAULT NULL,
  `iIdFacultad` int(11) NOT NULL,
  `iIdTipo` int(11) NOT NULL,
  PRIMARY KEY (`iIdUsuarios`),
  KEY `fk_Usuarios_Facultad1` (`iIdFacultad`),
  KEY `fk_Usuarios_Tipo1` (`iIdTipo`)
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `usuarios` (`iIdUsuarios`, `bCorreo`, `bPassword`, `bUsuario`, `iIdFacultad`, `iIdTipo`) VALUES
(1, 'administrador@gmail.com', 'administrador', 'administrador', 2, 1),
(2, 'catedratico@gmail.com', 'catedratico', 'catedratico', 1, 2),
(3, 'estudiante@gmail.com', 'estudiante', 'estudiante', 1, 3);
...
ALTER TABLE `asignacion`
  ADD CONSTRAINT `fk_Asignacion_Alumnos1` FOREIGN KEY (`iIdEstudiantes`) REFERENCES `estudiantes` (`iIdEstudiantes`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Asignacion_Carrera1` FOREIGN KEY (`iIdCarrera`) REFERENCES `carrera` (`iIdCarrera`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `asignacioncurso`
--
ALTER TABLE `asignacioncurso`
  ADD CONSTRAINT `fk_AsignacionCurso_Catedratico1` FOREIGN KEY (`iIdCatedratico`) REFERENCES `catedratico` (`iIdCatedratico`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `asignacioncursodetalle`
--
ALTER TABLE `asignacioncursodetalle`
  ADD CONSTRAINT `fk_AsignacionCursoDetalle_AsignacionCurso1` FOREIGN KEY (`iIdAsignacionCurso`) REFERENCES `asignacioncurso` (`iIdAsignacionCurso`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionCursoDetalle_Curso1` FOREIGN KEY (`iIdCurso`) REFERENCES `curso` (`iIdCurso`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionCursoDetalle_Jornada1` FOREIGN KEY (`iIdJornada`) REFERENCES `jornada` (`iIdJornada`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionCursoDetalle_Semestre1` FOREIGN KEY (`iIdSemestre`) REFERENCES `semestre` (`iIdSemestre`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionCursoDetalle_Seccion1` FOREIGN KEY (`iIdSeccion`) REFERENCES `seccion` (`iIdSeccion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionCursoDetalle_Facultad1` FOREIGN KEY (`iIdFacultad`) REFERENCES `facultad` (`iIdFacultad`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `asignaciondetalle`
--
ALTER TABLE `asignaciondetalle`
  ADD CONSTRAINT `fk_AsignacionDetalle_Curso1` FOREIGN KEY (`iIdCurso`) REFERENCES `curso` (`iIdCurso`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionDetalle_Horario1` FOREIGN KEY (`iIdHorario`) REFERENCES `horario` (`iIdHorario`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionDetalle_Seccion1` FOREIGN KEY (`iIdSeccion`) REFERENCES `seccion` (`iIdSeccion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionDetalle_Laboratorio1` FOREIGN KEY (`iIdLaboratorio`) REFERENCES `laboratorio` (`iIdLaboratorio`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionDetalle_Semestre1` FOREIGN KEY (`iIdSemestre`) REFERENCES `semestre` (`iIdSemestre`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionDetalle_Asignacion1` FOREIGN KEY (`iIdAsignacion`) REFERENCES `asignacion` (`idAsignacion`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `asignacionlista`
--
ALTER TABLE `asignacionlista`
  ADD CONSTRAINT `fk_AsignacionLista_Jornada1` FOREIGN KEY (`iIdJornada`) REFERENCES `jornada` (`iIdJornada`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionLista_Semestre1` FOREIGN KEY (`iIdSemestre`) REFERENCES `semestre` (`iIdSemestre`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionLista_Curso1` FOREIGN KEY (`iIdCurso`) REFERENCES `curso` (`iIdCurso`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionLista_Seccion1` FOREIGN KEY (`iIIdSeccion`) REFERENCES `seccion` (`iIdSeccion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionLista_Catedratico1` FOREIGN KEY (`iIdCatedratico`) REFERENCES `catedratico` (`iIdCatedratico`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `asignacionlistadetalle`
--
ALTER TABLE `asignacionlistadetalle`
  ADD CONSTRAINT `fk_AsignacionListaDetalle_AsignacionLista1` FOREIGN KEY (`iIdAsignacionLista`) REFERENCES `asignacionlista` (`iIdAsignacionLista`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_AsignacionListaDetalle_Alumnos1` FOREIGN KEY (`iIdAlumnos`) REFERENCES `estudiantes` (`iIdEstudiantes`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `bitacora`
--
ALTER TABLE `bitacora`
  ADD CONSTRAINT `fk_Bitacora_Usuarios1` FOREIGN KEY (`iIdUsuarios`) REFERENCES `usuarios` (`iIdUsuarios`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `carrera`
--
ALTER TABLE `carrera`
  ADD CONSTRAINT `fk_Carrera_Facultad1` FOREIGN KEY (`iIdFacultad`) REFERENCES `facultad` (`iIdFacultad`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `certificacion`
--
ALTER TABLE `certificacion`
  ADD CONSTRAINT `fk_Certificacion_Alumnos1` FOREIGN KEY (`iIdAlumnos`) REFERENCES `estudiantes` (`iIdEstudiantes`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `certificaciondetalle`
--
ALTER TABLE `certificaciondetalle`
  ADD CONSTRAINT `fk_CertificacionDetalle_Certificacion1` FOREIGN KEY (`iIdCertificacion`) REFERENCES `certificacion` (`iIdCertificacion`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_CertificacionDetalle_Curso1` FOREIGN KEY (`iIdCurso`) REFERENCES `curso` (`iIdCurso`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `detallepensum`
--
ALTER TABLE `detallepensum`
  ADD CONSTRAINT `fk_DetallePensum_Pensum1` FOREIGN KEY (`iIdPensum`) REFERENCES `pensum` (`iIdPensum`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_DetallePensum_Curso1` FOREIGN KEY (`iIdCurso`) REFERENCES `curso` (`iIdCurso`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `edificio`
--
ALTER TABLE `edificio`
  ADD CONSTRAINT `fk_Edificio_Facultad1` FOREIGN KEY (`iIdFacultad`) REFERENCES `facultad` (`iIdFacultad`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Edificio_Salon1` FOREIGN KEY (`iIdSalon`) REFERENCES `salon` (`iIdSalon`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `laboratorio`
--
ALTER TABLE `laboratorio`
  ADD CONSTRAINT `fk_Laboratorio_Salon1` FOREIGN KEY (`iIdSalon`) REFERENCES `salon` (`iIdSalon`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `pensum`
--
ALTER TABLE `pensum`
  ADD CONSTRAINT `fk_Pensum_Jornada1` FOREIGN KEY (`iIdJornada`) REFERENCES `jornada` (`iIdJornada`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Pensum_Carrera1` FOREIGN KEY (`idCarrera`) REFERENCES `carrera` (`iIdCarrera`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `seccion`
--
ALTER TABLE `seccion`
  ADD CONSTRAINT `fk_Seccion_Salon1` FOREIGN KEY (`iIdSalon`) REFERENCES `salon` (`iIdSalon`) ON DELETE CASCADE ON UPDATE CASCADE;

--
-- Filtros para la tabla `usuarios`
--
ALTER TABLE `usuarios`
  ADD CONSTRAINT `fk_Usuarios_Facultad1` FOREIGN KEY (`iIdFacultad`) REFERENCES `facultad` (`iIdFacultad`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_Usuarios_Tipo1` FOREIGN KEY (`iIdTipo`) REFERENCES `tipo` (`iIdTipo`) ON DELETE CASCADE ON UPDATE CASCADE;
--
-- Base de datos: `grupo`
--
CREATE DATABASE `grupo` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `grupo`;
...
('def', 'asignacioncursos', 'asignacion', 'idAsignacion', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacion', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacion', 'cFecha', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacion', 'iIdEstudiantes', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacion', 'iIdCarrera', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncurso', 'iIdAsignacionCurso', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncurso', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncurso', 'cFecha', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncurso', 'iIdCatedratico', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdAsignacionCursoDetalle', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdAsignacionCurso', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdCurso', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdJornada', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdSemestre', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdSeccion', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdFacultad', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 'iIdAsignacionDetalle', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 'cFecha', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 'iIdCurso', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 'iIdHorario', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 'iIdSeccion', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 'iIdLaboratorio', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 'iIdSemestre', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 'iIdAsignacion', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlista', 'iIdAsignacionLista', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlista', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlista', 'cFecha', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlista', 'bValidado', 4, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlista', 'iIdJornada', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlista', 'iIdSemestre', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlista', 'iIdCurso', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlista', 'iIIdSeccion', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlista', 'iIdCatedratico', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlistadetalle', 'iIdAsignacionListaDetalle', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlistadetalle', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlistadetalle', 'cStatus', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlistadetalle', 'cNota', 4, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlistadetalle', 'iIdAsignacionLista', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'asignacionlistadetalle', 'iIdAlumnos', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'bitacora', 'idBitacora', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'bitacora', 'fecha_ingreso', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'bitacora', 'fecho_cierre', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'bitacora', 'accion', 4, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'bitacora', 'ip', 5, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'bitacora', 'mac', 6, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'bitacora', 'nombrePC', 7, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'bitacora', 'iIdUsuarios', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'carrera', 'iIdCarrera', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'carrera', 'cNombre', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'carrera', 'iIdFacultad', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'catedratico', 'iIdCatedratico', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'catedratico', 'cNombres', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'catedratico', 'cApellido', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'catedratico', 'cEdad', 4, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'catedratico', 'cDireccion', 5, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'catedratico', 'cEmail', 6, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'catedratico', 'cTelefono', 7, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'catedratico', 'cGenero', 8, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'certificacion', 'iIdCertificacion', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'certificacion', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'certificacion', 'cFecha', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'certificacion', 'iIdAlumnos', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'certificaciondetalle', 'iIdCertificacionDetalle', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'certificaciondetalle', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'certificaciondetalle', 'iNota', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'certificaciondetalle', 'iIdCertificacion', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'certificaciondetalle', 'iIdCurso', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'curso', 'iIdCurso', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'curso', 'cNombre', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'curso', 'cDescripcion', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'curso', 'cCreditos', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'detallepensum', 'iIdPensum', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'detallepensum', 'iIdCurso', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'detallepensum', 'cDescripcion', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'edificio', 'iIdEdificio', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'edificio', 'cNombre', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'edificio', 'iIdFacultad', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'edificio', 'iIdSalon', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'estudiantes', 'iIdEstudiantes', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'estudiantes', 'cNombres', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'estudiantes', 'cApellidos', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'estudiantes', 'iEdad', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'estudiantes', 'cDireccion', 5, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'estudiantes', 'cEmail', 6, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'estudiantes', 'cTelefono', 7, NULL, 'YES', 'varchar', 8, 8, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(8)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'estudiantes', 'cGenero', 8, NULL, 'YES', 'varchar', 20, 20, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'facultad', 'iIdFacultad', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'facultad', 'cNombre', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'horario', 'iIdHorario', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'horario', 'cDuracion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'horario', 'cHoraInicio', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'horario', 'cHoraFinal', 4, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'jornada', 'iIdJornada', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'jornada', 'cNombre', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'laboratorio', 'iIdLaboratorio', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'laboratorio', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'laboratorio', 'iIdSalon', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'pensum', 'iIdPensum', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'pensum', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'pensum', 'cFecha', 3, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'pensum', 'cCreditos', 4, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'pensum', 'iIdJornada', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'pensum', 'idCarrera', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'salon', 'iIdSalon', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'salon', 'cNoSalon', 2, NULL, 'YES', 'varchar', 10, 10, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'seccion', 'iIdSeccion', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'seccion', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'seccion', 'cCapacidad', 3, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'seccion', 'iIdSalon', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'semestre', 'iIdSemestre', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'semestre', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'tipo', 'iIdTipo', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'tipo', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'usuarios', 'iIdUsuarios', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'usuarios', 'bCorreo', 2, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'usuarios', 'bPassword', 3, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'usuarios', 'bUsuario', 4, NULL, 'YES', 'varchar', 50, 50, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(50)', '', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'usuarios', 'iIdFacultad', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'asignacioncursos', 'usuarios', 'iIdTipo', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'grupo', 'usuarios', 'usuario', 1, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'grupo', 'usuarios', 'password', 2, NULL, 'NO', 'varchar', 25, 25, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(25)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacion', 'idAsignacion', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacion', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacion', 'cFecha', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacion', 'iIdEstudiantes', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacion', 'iIdCarrera', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncurso', 'iIdAsignacionCurso', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncurso', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncurso', 'cFecha', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncurso', 'iIdCatedratico', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncursodetalle', 'iIdAsignacionCursoDetalle', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncursodetalle', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncursodetalle', 'iIdAsignacionCurso', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncursodetalle', 'iIdCurso', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncursodetalle', 'iIdJornada', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncursodetalle', 'iIdSemestre', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncursodetalle', 'iIdSeccion', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacioncursodetalle', 'iIdFacultad', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignaciondetalle', 'iIdAsignacionDetalle', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignaciondetalle', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignaciondetalle', 'cFecha', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignaciondetalle', 'iIdCurso', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignaciondetalle', 'iIdHorario', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignaciondetalle', 'iIdSeccion', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignaciondetalle', 'iIdLaboratorio', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignaciondetalle', 'iIdSemestre', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignaciondetalle', 'iIdAsignacion', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlista', 'iIdAsignacionLista', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlista', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlista', 'cFecha', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlista', 'bValidado', 4, NULL, 'YES', 'tinyint', NULL, NULL, 3, 0, NULL, NULL, 'tinyint(4)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlista', 'iIdJornada', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlista', 'iIdSemestre', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlista', 'iIdCurso', 7, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlista', 'iIIdSeccion', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlista', 'iIdCatedratico', 9, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlistadetalle', 'iIdAsignacionListaDetalle', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlistadetalle', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlistadetalle', 'cStatus', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlistadetalle', 'cNota', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlistadetalle', 'iIdAsignacionLista', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'asignacionlistadetalle', 'iIdAlumnos', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'bitacora', 'idBitacora', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'bitacora', 'fecha_ingreso', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'bitacora', 'fecho_cierre', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'bitacora', 'accion', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'bitacora', 'ip', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'bitacora', 'mac', 6, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'bitacora', 'nombrePC', 7, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'bitacora', 'iIdUsuarios', 8, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'carrera', 'iIdCarrera', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'carrera', 'cNombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'carrera', 'iIdFacultad', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', '');
INSERT INTO `COLUMNS` (`TABLE_CATALOG`, `TABLE_SCHEMA`, `TABLE_NAME`, `COLUMN_NAME`, `ORDINAL_POSITION`, `COLUMN_DEFAULT`, `IS_NULLABLE`, `DATA_TYPE`, `CHARACTER_MAXIMUM_LENGTH`, `CHARACTER_OCTET_LENGTH`, `NUMERIC_PRECISION`, `NUMERIC_SCALE`, `CHARACTER_SET_NAME`, `COLLATION_NAME`, `COLUMN_TYPE`, `COLUMN_KEY`, `EXTRA`, `PRIVILEGES`, `COLUMN_COMMENT`) VALUES
('def', 'mydb', 'catedratico', 'iIdCatedratico', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'catedratico', 'cNombres', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'catedratico', 'cApellido', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'catedratico', 'cEdad', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'catedratico', 'cDireccion', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'catedratico', 'cEmail', 6, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'catedratico', 'cTelefono', 7, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'catedratico', 'cGenero', 8, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'certificacion', 'iIdCertificacion', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'certificacion', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'certificacion', 'cFecha', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'certificacion', 'iIdAlumnos', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'certificaciondetalle', 'iIdCertificacionDetalle', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'certificaciondetalle', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'certificaciondetalle', 'iNota', 3, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'certificaciondetalle', 'iIdCertificacion', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'certificaciondetalle', 'iIdCurso', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'curso', 'iIdCurso', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'curso', 'cNombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'curso', 'cDescripcion', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'curso', 'cCreditos', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'detallepensum', 'iIdPensum', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'detallepensum', 'iIdCurso', 2, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'detallepensum', 'cDescripcion', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'edificio', 'iIdEdificio', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'edificio', 'cNombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'edificio', 'iIdFacultad', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'edificio', 'iIdSalon', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'estudiantes', 'iIdEstudiantes', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'estudiantes', 'cNombres', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'estudiantes', 'cApellidos', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'estudiantes', 'iEdad', 4, NULL, 'YES', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'estudiantes', 'cDireccion', 5, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'estudiantes', 'cEmail', 6, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'estudiantes', 'cTelefono', 7, NULL, 'YES', 'varchar', 8, 24, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(8)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'estudiantes', 'cGenero', 8, NULL, 'YES', 'varchar', 20, 60, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(20)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'facultad', 'iIdFacultad', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'facultad', 'cNombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'horario', 'iIdHorario', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'horario', 'cDuracion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'horario', 'cHoraInicio', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'horario', 'cHoraFinal', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'jornada', 'iIdJornada', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'jornada', 'cNombre', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'laboratorio', 'iIdLaboratorio', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'laboratorio', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'laboratorio', 'iIdSalon', 3, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'pensum', 'iIdPensum', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'pensum', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'pensum', 'cFecha', 3, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'pensum', 'cCreditos', 4, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'pensum', 'iIdJornada', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'pensum', 'idCarrera', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'salon', 'iIdSalon', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'salon', 'cNoSalon', 2, NULL, 'YES', 'varchar', 10, 30, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(10)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'seccion', 'iIdSeccion', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'seccion', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'seccion', 'cCapacidad', 3, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'seccion', 'iIdSalon', 4, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'semestre', 'iIdSemestre', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'semestre', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'tipo', 'iIdTipo', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'tipo', 'cDescripcion', 2, NULL, 'YES', 'varchar', 45, 135, NULL, NULL, 'utf8', 'utf8_general_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'usuarios', 'iIdUsuarios', 1, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'PRI', '', 'select,insert,update,references', ''),
('def', 'mydb', 'usuarios', 'bCorreo', 2, NULL, 'YES', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'usuarios', 'bPassword', 3, NULL, 'YES', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'usuarios', 'bUsuario', 4, NULL, 'YES', 'blob', 65535, 65535, NULL, NULL, NULL, NULL, 'blob', '', '', 'select,insert,update,references', ''),
('def', 'mydb', 'usuarios', 'iIdFacultad', 5, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
('def', 'mydb', 'usuarios', 'iIdTipo', 6, NULL, 'NO', 'int', NULL, NULL, 10, 0, NULL, NULL, 'int(11)', 'MUL', '', 'select,insert,update,references', ''),
...
('def', 'sistemas', 'usuarios', 'usuario', 1, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', ''),
('def', 'sistemas', 'usuarios', 'password', 2, NULL, 'YES', 'varchar', 45, 45, NULL, NULL, 'latin1', 'latin1_swedish_ci', 'varchar(45)', '', '', 'select,insert,update,references', '');
...
('COM_SHOW_SLAVE_STATUS', '21'),
('COM_SHOW_STATUS', '0'),
('COM_SHOW_STORAGE_ENGINES', '0'),
('COM_SHOW_TABLE_STATUS', '243'),
('COM_SHOW_TABLES', '87'),
...
('HANDLER_DISCOVER', '0'),
('HANDLER_PREPARE', '26'),
('HANDLER_READ_FIRST', '399'),
('HANDLER_READ_KEY', '395'),
('HANDLER_READ_LAST', '0'),
('HANDLER_READ_NEXT', '126'),
('HANDLER_READ_PREV', '0'),
('HANDLER_READ_RND', '3'),
('HANDLER_READ_RND_NEXT', '17263'),
('HANDLER_ROLLBACK', '6'),
('HANDLER_SAVEPOINT', '0'),
('HANDLER_SAVEPOINT_ROLLBACK', '0'),
('HANDLER_UPDATE', '1'),
('HANDLER_WRITE', '16365'),
('INNODB_BUFFER_POOL_PAGES_DATA', '440'),
('INNODB_BUFFER_POOL_PAGES_DIRTY', '0'),
('INNODB_BUFFER_POOL_PAGES_FLUSHED', '1640'),
('INNODB_BUFFER_POOL_PAGES_FREE', '7751'),
('INNODB_BUFFER_POOL_PAGES_MISC', '1'),
('INNODB_BUFFER_POOL_PAGES_TOTAL', '8192'),
('INNODB_BUFFER_POOL_READ_AHEAD_RND', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '32335'),
('INNODB_BUFFER_POOL_READS', '174'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '9347'),
('INNODB_DATA_FSYNCS', '327'),
('INNODB_DATA_PENDING_FSYNCS', '0'),
('INNODB_DATA_PENDING_READS', '0'),
('INNODB_DATA_PENDING_WRITES', '0'),
('INNODB_DATA_READ', '5033984'),
('INNODB_DATA_READS', '184'),
('INNODB_DATA_WRITES', '1114'),
('INNODB_DATA_WRITTEN', '27605504'),
('INNODB_DBLWR_PAGES_WRITTEN', '820'),
('INNODB_DBLWR_WRITES', '37'),
('INNODB_HAVE_ATOMIC_BUILTINS', 'ON'),
('INNODB_LOG_WAITS', '0'),
('INNODB_LOG_WRITE_REQUESTS', '1423'),
('INNODB_LOG_WRITES', '220'),
('INNODB_OS_LOG_FSYNCS', '253'),
('INNODB_OS_LOG_PENDING_FSYNCS', '0'),
('INNODB_OS_LOG_PENDING_WRITES', '0'),
('INNODB_OS_LOG_WRITTEN', '718848'),
('INNODB_PAGE_SIZE', '16384'),
('INNODB_PAGES_CREATED', '267'),
('INNODB_PAGES_READ', '173'),
('INNODB_PAGES_WRITTEN', '820'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '11632'),
('UPTIME_SINCE_FLUSH_STATUS', '11632');
...
('PID_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\DESKTOP-MV9IDU4.pid'),
('KEY_CACHE_DIVISION_LIMIT', '100'),
('COLLATION_SERVER', 'latin1_swedish_ci'),
('GENERAL_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\DESKTOP-MV9IDU4.log'),
('FLUSH_TIME', '1800'),
...
('SLOW_QUERY_LOG_FILE', 'c:\\wamp\\bin\\mysql\\mysql5.5.24\\data\\DESKTOP-MV9IDU4-slow.log'),
...
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'asignacion', 'idAsignacion', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_Asignacion_Alumnos1', 'def', 'asignacioncursos', 'asignacion', 'iIdEstudiantes', 1, 1, 'asignacioncursos', 'estudiantes', 'iIdEstudiantes'),
('def', 'asignacioncursos', 'fk_Asignacion_Carrera1', 'def', 'asignacioncursos', 'asignacion', 'iIdCarrera', 1, 1, 'asignacioncursos', 'carrera', 'iIdCarrera'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'asignacioncurso', 'iIdAsignacionCurso', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_AsignacionCurso_Catedratico1', 'def', 'asignacioncursos', 'asignacioncurso', 'iIdCatedratico', 1, 1, 'asignacioncursos', 'catedratico', 'iIdCatedratico'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdAsignacionCursoDetalle', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_AsignacionCurso1', 'def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdAsignacionCurso', 1, 1, 'asignacioncursos', 'asignacioncurso', 'iIdAsignacionCurso'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Curso1', 'def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdCurso', 1, 1, 'asignacioncursos', 'curso', 'iIdCurso'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Jornada1', 'def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdJornada', 1, 1, 'asignacioncursos', 'jornada', 'iIdJornada'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Semestre1', 'def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdSemestre', 1, 1, 'asignacioncursos', 'semestre', 'iIdSemestre'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Seccion1', 'def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdSeccion', 1, 1, 'asignacioncursos', 'seccion', 'iIdSeccion'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Facultad1', 'def', 'asignacioncursos', 'asignacioncursodetalle', 'iIdFacultad', 1, 1, 'asignacioncursos', 'facultad', 'iIdFacultad'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'asignaciondetalle', 'iIdAsignacionDetalle', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Curso1', 'def', 'asignacioncursos', 'asignaciondetalle', 'iIdCurso', 1, 1, 'asignacioncursos', 'curso', 'iIdCurso'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Horario1', 'def', 'asignacioncursos', 'asignaciondetalle', 'iIdHorario', 1, 1, 'asignacioncursos', 'horario', 'iIdHorario'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Seccion1', 'def', 'asignacioncursos', 'asignaciondetalle', 'iIdSeccion', 1, 1, 'asignacioncursos', 'seccion', 'iIdSeccion'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Laboratorio1', 'def', 'asignacioncursos', 'asignaciondetalle', 'iIdLaboratorio', 1, 1, 'asignacioncursos', 'laboratorio', 'iIdLaboratorio'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Semestre1', 'def', 'asignacioncursos', 'asignaciondetalle', 'iIdSemestre', 1, 1, 'asignacioncursos', 'semestre', 'iIdSemestre'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Asignacion1', 'def', 'asignacioncursos', 'asignaciondetalle', 'iIdAsignacion', 1, 1, 'asignacioncursos', 'asignacion', 'idAsignacion'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'asignacionlista', 'iIdAsignacionLista', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_AsignacionLista_Jornada1', 'def', 'asignacioncursos', 'asignacionlista', 'iIdJornada', 1, 1, 'asignacioncursos', 'jornada', 'iIdJornada'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Semestre1', 'def', 'asignacioncursos', 'asignacionlista', 'iIdSemestre', 1, 1, 'asignacioncursos', 'semestre', 'iIdSemestre'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Curso1', 'def', 'asignacioncursos', 'asignacionlista', 'iIdCurso', 1, 1, 'asignacioncursos', 'curso', 'iIdCurso'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Seccion1', 'def', 'asignacioncursos', 'asignacionlista', 'iIIdSeccion', 1, 1, 'asignacioncursos', 'seccion', 'iIdSeccion'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Catedratico1', 'def', 'asignacioncursos', 'asignacionlista', 'iIdCatedratico', 1, 1, 'asignacioncursos', 'catedratico', 'iIdCatedratico'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'asignacionlistadetalle', 'iIdAsignacionListaDetalle', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_AsignacionListaDetalle_AsignacionLista1', 'def', 'asignacioncursos', 'asignacionlistadetalle', 'iIdAsignacionLista', 1, 1, 'asignacioncursos', 'asignacionlista', 'iIdAsignacionLista'),
('def', 'asignacioncursos', 'fk_AsignacionListaDetalle_Alumnos1', 'def', 'asignacioncursos', 'asignacionlistadetalle', 'iIdAlumnos', 1, 1, 'asignacioncursos', 'estudiantes', 'iIdEstudiantes'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'bitacora', 'idBitacora', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_Bitacora_Usuarios1', 'def', 'asignacioncursos', 'bitacora', 'iIdUsuarios', 1, 1, 'asignacioncursos', 'usuarios', 'iIdUsuarios'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'carrera', 'iIdCarrera', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_Carrera_Facultad1', 'def', 'asignacioncursos', 'carrera', 'iIdFacultad', 1, 1, 'asignacioncursos', 'facultad', 'iIdFacultad'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'catedratico', 'iIdCatedratico', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'certificacion', 'iIdCertificacion', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_Certificacion_Alumnos1', 'def', 'asignacioncursos', 'certificacion', 'iIdAlumnos', 1, 1, 'asignacioncursos', 'estudiantes', 'iIdEstudiantes'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'certificaciondetalle', 'iIdCertificacionDetalle', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_CertificacionDetalle_Certificacion1', 'def', 'asignacioncursos', 'certificaciondetalle', 'iIdCertificacion', 1, 1, 'asignacioncursos', 'certificacion', 'iIdCertificacion'),
('def', 'asignacioncursos', 'fk_CertificacionDetalle_Curso1', 'def', 'asignacioncursos', 'certificaciondetalle', 'iIdCurso', 1, 1, 'asignacioncursos', 'curso', 'iIdCurso'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'curso', 'iIdCurso', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'detallepensum', 'iIdPensum', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'detallepensum', 'iIdCurso', 2, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_DetallePensum_Pensum1', 'def', 'asignacioncursos', 'detallepensum', 'iIdPensum', 1, 1, 'asignacioncursos', 'pensum', 'iIdPensum'),
('def', 'asignacioncursos', 'fk_DetallePensum_Curso1', 'def', 'asignacioncursos', 'detallepensum', 'iIdCurso', 1, 1, 'asignacioncursos', 'curso', 'iIdCurso'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'edificio', 'iIdEdificio', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_Edificio_Facultad1', 'def', 'asignacioncursos', 'edificio', 'iIdFacultad', 1, 1, 'asignacioncursos', 'facultad', 'iIdFacultad'),
('def', 'asignacioncursos', 'fk_Edificio_Salon1', 'def', 'asignacioncursos', 'edificio', 'iIdSalon', 1, 1, 'asignacioncursos', 'salon', 'iIdSalon'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'estudiantes', 'iIdEstudiantes', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'facultad', 'iIdFacultad', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'horario', 'iIdHorario', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'jornada', 'iIdJornada', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'laboratorio', 'iIdLaboratorio', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_Laboratorio_Salon1', 'def', 'asignacioncursos', 'laboratorio', 'iIdSalon', 1, 1, 'asignacioncursos', 'salon', 'iIdSalon'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'pensum', 'iIdPensum', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_Pensum_Jornada1', 'def', 'asignacioncursos', 'pensum', 'iIdJornada', 1, 1, 'asignacioncursos', 'jornada', 'iIdJornada'),
('def', 'asignacioncursos', 'fk_Pensum_Carrera1', 'def', 'asignacioncursos', 'pensum', 'idCarrera', 1, 1, 'asignacioncursos', 'carrera', 'iIdCarrera'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'salon', 'iIdSalon', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'seccion', 'iIdSeccion', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_Seccion_Salon1', 'def', 'asignacioncursos', 'seccion', 'iIdSalon', 1, 1, 'asignacioncursos', 'salon', 'iIdSalon'),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'semestre', 'iIdSemestre', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'tipo', 'iIdTipo', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'PRIMARY', 'def', 'asignacioncursos', 'usuarios', 'iIdUsuarios', 1, NULL, NULL, NULL, NULL),
('def', 'asignacioncursos', 'fk_Usuarios_Facultad1', 'def', 'asignacioncursos', 'usuarios', 'iIdFacultad', 1, 1, 'asignacioncursos', 'facultad', 'iIdFacultad'),
('def', 'asignacioncursos', 'fk_Usuarios_Tipo1', 'def', 'asignacioncursos', 'usuarios', 'iIdTipo', 1, 1, 'asignacioncursos', 'tipo', 'iIdTipo'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'asignacion', 'idAsignacion', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_Asignacion_Alumnos1', 'def', 'mydb', 'asignacion', 'iIdEstudiantes', 1, 1, 'mydb', 'estudiantes', 'iIdEstudiantes'),
('def', 'mydb', 'fk_Asignacion_Carrera1', 'def', 'mydb', 'asignacion', 'iIdCarrera', 1, 1, 'mydb', 'carrera', 'iIdCarrera'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'asignacioncurso', 'iIdAsignacionCurso', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_AsignacionCurso_Catedratico1', 'def', 'mydb', 'asignacioncurso', 'iIdCatedratico', 1, 1, 'mydb', 'catedratico', 'iIdCatedratico'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'asignacioncursodetalle', 'iIdAsignacionCursoDetalle', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_AsignacionCursoDetalle_AsignacionCurso1', 'def', 'mydb', 'asignacioncursodetalle', 'iIdAsignacionCurso', 1, 1, 'mydb', 'asignacioncurso', 'iIdAsignacionCurso'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Curso1', 'def', 'mydb', 'asignacioncursodetalle', 'iIdCurso', 1, 1, 'mydb', 'curso', 'iIdCurso'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Jornada1', 'def', 'mydb', 'asignacioncursodetalle', 'iIdJornada', 1, 1, 'mydb', 'jornada', 'iIdJornada'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Semestre1', 'def', 'mydb', 'asignacioncursodetalle', 'iIdSemestre', 1, 1, 'mydb', 'semestre', 'iIdSemestre'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Seccion1', 'def', 'mydb', 'asignacioncursodetalle', 'iIdSeccion', 1, 1, 'mydb', 'seccion', 'iIdSeccion'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Facultad1', 'def', 'mydb', 'asignacioncursodetalle', 'iIdFacultad', 1, 1, 'mydb', 'facultad', 'iIdFacultad'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'asignaciondetalle', 'iIdAsignacionDetalle', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_AsignacionDetalle_Curso1', 'def', 'mydb', 'asignaciondetalle', 'iIdCurso', 1, 1, 'mydb', 'curso', 'iIdCurso'),
('def', 'mydb', 'fk_AsignacionDetalle_Horario1', 'def', 'mydb', 'asignaciondetalle', 'iIdHorario', 1, 1, 'mydb', 'horario', 'iIdHorario'),
('def', 'mydb', 'fk_AsignacionDetalle_Seccion1', 'def', 'mydb', 'asignaciondetalle', 'iIdSeccion', 1, 1, 'mydb', 'seccion', 'iIdSeccion'),
('def', 'mydb', 'fk_AsignacionDetalle_Laboratorio1', 'def', 'mydb', 'asignaciondetalle', 'iIdLaboratorio', 1, 1, 'mydb', 'laboratorio', 'iIdLaboratorio'),
('def', 'mydb', 'fk_AsignacionDetalle_Semestre1', 'def', 'mydb', 'asignaciondetalle', 'iIdSemestre', 1, 1, 'mydb', 'semestre', 'iIdSemestre'),
('def', 'mydb', 'fk_AsignacionDetalle_Asignacion1', 'def', 'mydb', 'asignaciondetalle', 'iIdAsignacion', 1, 1, 'mydb', 'asignacion', 'idAsignacion'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'asignacionlista', 'iIdAsignacionLista', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_AsignacionLista_Jornada1', 'def', 'mydb', 'asignacionlista', 'iIdJornada', 1, 1, 'mydb', 'jornada', 'iIdJornada'),
('def', 'mydb', 'fk_AsignacionLista_Semestre1', 'def', 'mydb', 'asignacionlista', 'iIdSemestre', 1, 1, 'mydb', 'semestre', 'iIdSemestre'),
('def', 'mydb', 'fk_AsignacionLista_Curso1', 'def', 'mydb', 'asignacionlista', 'iIdCurso', 1, 1, 'mydb', 'curso', 'iIdCurso'),
('def', 'mydb', 'fk_AsignacionLista_Seccion1', 'def', 'mydb', 'asignacionlista', 'iIIdSeccion', 1, 1, 'mydb', 'seccion', 'iIdSeccion'),
('def', 'mydb', 'fk_AsignacionLista_Catedratico1', 'def', 'mydb', 'asignacionlista', 'iIdCatedratico', 1, 1, 'mydb', 'catedratico', 'iIdCatedratico'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'asignacionlistadetalle', 'iIdAsignacionListaDetalle', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_AsignacionListaDetalle_AsignacionLista1', 'def', 'mydb', 'asignacionlistadetalle', 'iIdAsignacionLista', 1, 1, 'mydb', 'asignacionlista', 'iIdAsignacionLista'),
('def', 'mydb', 'fk_AsignacionListaDetalle_Alumnos1', 'def', 'mydb', 'asignacionlistadetalle', 'iIdAlumnos', 1, 1, 'mydb', 'estudiantes', 'iIdEstudiantes'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'bitacora', 'idBitacora', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_Bitacora_Usuarios1', 'def', 'mydb', 'bitacora', 'iIdUsuarios', 1, 1, 'mydb', 'usuarios', 'iIdUsuarios'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'carrera', 'iIdCarrera', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_Carrera_Facultad1', 'def', 'mydb', 'carrera', 'iIdFacultad', 1, 1, 'mydb', 'facultad', 'iIdFacultad'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'catedratico', 'iIdCatedratico', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'certificacion', 'iIdCertificacion', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_Certificacion_Alumnos1', 'def', 'mydb', 'certificacion', 'iIdAlumnos', 1, 1, 'mydb', 'estudiantes', 'iIdEstudiantes'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'certificaciondetalle', 'iIdCertificacionDetalle', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_CertificacionDetalle_Certificacion1', 'def', 'mydb', 'certificaciondetalle', 'iIdCertificacion', 1, 1, 'mydb', 'certificacion', 'iIdCertificacion'),
('def', 'mydb', 'fk_CertificacionDetalle_Curso1', 'def', 'mydb', 'certificaciondetalle', 'iIdCurso', 1, 1, 'mydb', 'curso', 'iIdCurso'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'curso', 'iIdCurso', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'detallepensum', 'iIdPensum', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'detallepensum', 'iIdCurso', 2, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_DetallePensum_Pensum1', 'def', 'mydb', 'detallepensum', 'iIdPensum', 1, 1, 'mydb', 'pensum', 'iIdPensum'),
('def', 'mydb', 'fk_DetallePensum_Curso1', 'def', 'mydb', 'detallepensum', 'iIdCurso', 1, 1, 'mydb', 'curso', 'iIdCurso'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'edificio', 'iIdEdificio', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_Edificio_Facultad1', 'def', 'mydb', 'edificio', 'iIdFacultad', 1, 1, 'mydb', 'facultad', 'iIdFacultad'),
('def', 'mydb', 'fk_Edificio_Salon1', 'def', 'mydb', 'edificio', 'iIdSalon', 1, 1, 'mydb', 'salon', 'iIdSalon'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'estudiantes', 'iIdEstudiantes', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'facultad', 'iIdFacultad', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'horario', 'iIdHorario', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'jornada', 'iIdJornada', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'laboratorio', 'iIdLaboratorio', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_Laboratorio_Salon1', 'def', 'mydb', 'laboratorio', 'iIdSalon', 1, 1, 'mydb', 'salon', 'iIdSalon'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'pensum', 'iIdPensum', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_Pensum_Jornada1', 'def', 'mydb', 'pensum', 'iIdJornada', 1, 1, 'mydb', 'jornada', 'iIdJornada'),
('def', 'mydb', 'fk_Pensum_Carrera1', 'def', 'mydb', 'pensum', 'idCarrera', 1, 1, 'mydb', 'carrera', 'iIdCarrera'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'salon', 'iIdSalon', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'seccion', 'iIdSeccion', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_Seccion_Salon1', 'def', 'mydb', 'seccion', 'iIdSalon', 1, 1, 'mydb', 'salon', 'iIdSalon'),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'semestre', 'iIdSemestre', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'tipo', 'iIdTipo', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'PRIMARY', 'def', 'mydb', 'usuarios', 'iIdUsuarios', 1, NULL, NULL, NULL, NULL),
('def', 'mydb', 'fk_Usuarios_Facultad1', 'def', 'mydb', 'usuarios', 'iIdFacultad', 1, 1, 'mydb', 'facultad', 'iIdFacultad'),
('def', 'mydb', 'fk_Usuarios_Tipo1', 'def', 'mydb', 'usuarios', 'iIdTipo', 1, 1, 'mydb', 'tipo', 'iIdTipo'),
...
('def', 'information_schema', 'CHARACTER_SETS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 384, 0, 16434816, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 231, 0, 16704765, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 195, 0, 16357770, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMNS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-07-29 01:40:57', '2019-07-29 01:40:57', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'COLUMN_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2565, 0, 16757145, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ENGINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 490, 0, 16574250, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'EVENTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-07-29 01:40:57', '2019-07-29 01:40:57', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'FILES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2677, 0, 16758020, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'GLOBAL_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'KEY_COLUMN_USAGE', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4637, 0, 16762755, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARAMETERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-07-29 01:40:57', '2019-07-29 01:40:57', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PARTITIONS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-07-29 01:40:57', '2019-07-29 01:40:57', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PLUGINS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-07-29 01:40:57', '2019-07-29 01:40:57', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROCESSLIST', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-07-29 01:40:57', '2019-07-29 01:40:57', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'PROFILING', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 308, 0, 16562084, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4814, 0, 16767162, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'ROUTINES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-07-29 01:40:57', '2019-07-29 01:40:57', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMATA', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3464, 0, 16738048, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2179, 0, 16736899, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_STATUS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'SESSION_VARIABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 3268, 0, 16755036, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'STATISTICS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 5753, 0, 16752736, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 9450, 0, 16764300, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLESPACES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 6951, 0, 16772763, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_CONSTRAINTS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2504, 0, 16721712, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TABLE_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 2372, 0, 16748692, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'TRIGGERS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-07-29 01:40:57', '2019-07-29 01:40:57', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'USER_PRIVILEGES', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 1986, 0, 16726092, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'VIEWS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 0, 281474976710655, 1024, 0, '2019-07-29 01:40:57', '2019-07-29 01:40:57', NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_TRX', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 4534, 0, 16766732, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCK_WAITS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 599, 0, 16749238, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMPMEM', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 29, 0, 15204352, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_CMP', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 25, 0, 13107200, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'information_schema', 'INNODB_LOCKS', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 31244, 0, 16746784, 0, 0, '2019-07-29 01:40:57', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'asignacion', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:35:59', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'asignacioncurso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:36:00', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'asignacioncursodetalle', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 98304, 0, '2019-07-29 01:36:00', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'asignaciondetalle', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 98304, 0, '2019-07-29 01:35:59', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'asignacionlista', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 81920, 0, '2019-07-29 01:35:59', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'asignacionlistadetalle', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:35:59', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'bitacora', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:36:01', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'carrera', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:35:57', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'catedratico', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:35:59', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'certificacion', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:36:00', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'certificaciondetalle', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:36:00', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'curso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:35:58', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'detallepensum', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:35:58', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'edificio', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:35:57', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'estudiantes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:35:56', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'facultad', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2019-07-29 01:35:56', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'horario', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:35:58', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'jornada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:35:58', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'laboratorio', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:35:58', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'pensum', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:35:58', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'salon', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:35:57', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'seccion', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:35:58', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'semestre', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:35:58', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'tipo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2019-07-29 01:35:56', NULL, NULL, NULL, '', '', NULL),
('def', 'asignacioncursos', 'usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 32768, 0, '2019-07-29 01:35:57', NULL, NULL, NULL, '', '', NULL),
('def', 'grupo', 'usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 2, 8192, 16384, NULL, 0, 0, '2019-05-24 00:15:45', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'asignacion', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:29:55', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'asignacioncurso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:29:57', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'asignacioncursodetalle', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 98304, 0, '2019-07-29 01:29:57', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'asignaciondetalle', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 98304, 0, '2019-07-29 01:29:56', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'asignacionlista', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 81920, 0, '2019-07-29 01:29:56', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'asignacionlistadetalle', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:29:57', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'bitacora', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:29:57', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'carrera', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:29:54', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'catedratico', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:29:56', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'certificacion', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:29:57', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'certificaciondetalle', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:29:57', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'curso', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:29:55', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'detallepensum', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:29:55', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'edificio', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:29:55', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'estudiantes', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:29:54', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'facultad', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:29:54', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'horario', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:29:55', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'jornada', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:29:55', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'laboratorio', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:29:55', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'pensum', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:29:55', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'salon', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:29:54', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'seccion', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 16384, 0, '2019-07-29 01:29:55', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'semestre', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:29:55', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'tipo', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 0, 0, '2019-07-29 01:29:54', NULL, NULL, NULL, '', '', NULL),
('def', 'mydb', 'usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 0, 0, 16384, NULL, 32768, 0, '2019-07-29 01:29:54', NULL, NULL, NULL, '', '', NULL),
...
('def', 'sistemas', 'usuarios', NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, NULL, 3, 5461, 16384, NULL, 0, 0, '2019-05-22 02:58:11', NULL, NULL, NULL, '', '', NULL);
...
(318, 'root', 'localhost:54356', 'grupo', 'Query', 0, 'executing', 'SELECT * FROM `information_schema`.`PROCESSLIST`');
...
('def', 'asignacioncursos', 'fk_Asignacion_Alumnos1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacion', 'estudiantes'),
('def', 'asignacioncursos', 'fk_Asignacion_Carrera1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacion', 'carrera'),
('def', 'asignacioncursos', 'fk_AsignacionCurso_Catedratico1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncurso', 'catedratico'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_AsignacionCurso1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'asignacioncurso'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Curso1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'curso'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Jornada1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'jornada'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Semestre1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'semestre'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Seccion1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'seccion'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Facultad1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'facultad'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Curso1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'curso'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Horario1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'horario'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Seccion1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'seccion'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Laboratorio1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'laboratorio'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Semestre1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'semestre'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Asignacion1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'asignacion'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Jornada1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlista', 'jornada'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Semestre1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlista', 'semestre'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Curso1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlista', 'curso'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Seccion1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlista', 'seccion'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Catedratico1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlista', 'catedratico'),
('def', 'asignacioncursos', 'fk_AsignacionListaDetalle_AsignacionLista1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlistadetalle', 'asignacionlista'),
('def', 'asignacioncursos', 'fk_AsignacionListaDetalle_Alumnos1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlistadetalle', 'estudiantes'),
('def', 'asignacioncursos', 'fk_Bitacora_Usuarios1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'bitacora', 'usuarios'),
('def', 'asignacioncursos', 'fk_Carrera_Facultad1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'carrera', 'facultad'),
('def', 'asignacioncursos', 'fk_Certificacion_Alumnos1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'certificacion', 'estudiantes'),
('def', 'asignacioncursos', 'fk_CertificacionDetalle_Certificacion1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'certificaciondetalle', 'certificacion'),
('def', 'asignacioncursos', 'fk_CertificacionDetalle_Curso1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'certificaciondetalle', 'curso'),
('def', 'asignacioncursos', 'fk_DetallePensum_Pensum1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'detallepensum', 'pensum'),
('def', 'asignacioncursos', 'fk_DetallePensum_Curso1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'detallepensum', 'curso'),
('def', 'asignacioncursos', 'fk_Edificio_Facultad1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'edificio', 'facultad'),
('def', 'asignacioncursos', 'fk_Edificio_Salon1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'edificio', 'salon'),
('def', 'asignacioncursos', 'fk_Laboratorio_Salon1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'laboratorio', 'salon'),
('def', 'asignacioncursos', 'fk_Pensum_Jornada1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'pensum', 'jornada'),
('def', 'asignacioncursos', 'fk_Pensum_Carrera1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'pensum', 'carrera'),
('def', 'asignacioncursos', 'fk_Seccion_Salon1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'seccion', 'salon'),
('def', 'asignacioncursos', 'fk_Usuarios_Facultad1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'usuarios', 'facultad'),
('def', 'asignacioncursos', 'fk_Usuarios_Tipo1', 'def', 'asignacioncursos', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'usuarios', 'tipo'),
('def', 'mydb', 'fk_Asignacion_Alumnos1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacion', 'estudiantes'),
('def', 'mydb', 'fk_Asignacion_Carrera1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacion', 'carrera'),
('def', 'mydb', 'fk_AsignacionCurso_Catedratico1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncurso', 'catedratico'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_AsignacionCurso1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'asignacioncurso'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Curso1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'curso'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Jornada1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'jornada'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Semestre1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'semestre'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Seccion1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'seccion'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Facultad1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacioncursodetalle', 'facultad'),
('def', 'mydb', 'fk_AsignacionDetalle_Curso1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'curso'),
('def', 'mydb', 'fk_AsignacionDetalle_Horario1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'horario'),
('def', 'mydb', 'fk_AsignacionDetalle_Seccion1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'seccion'),
('def', 'mydb', 'fk_AsignacionDetalle_Laboratorio1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'laboratorio'),
('def', 'mydb', 'fk_AsignacionDetalle_Semestre1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'semestre'),
('def', 'mydb', 'fk_AsignacionDetalle_Asignacion1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignaciondetalle', 'asignacion'),
('def', 'mydb', 'fk_AsignacionLista_Jornada1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlista', 'jornada'),
('def', 'mydb', 'fk_AsignacionLista_Semestre1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlista', 'semestre'),
('def', 'mydb', 'fk_AsignacionLista_Curso1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlista', 'curso'),
('def', 'mydb', 'fk_AsignacionLista_Seccion1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlista', 'seccion'),
('def', 'mydb', 'fk_AsignacionLista_Catedratico1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlista', 'catedratico'),
('def', 'mydb', 'fk_AsignacionListaDetalle_AsignacionLista1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlistadetalle', 'asignacionlista'),
('def', 'mydb', 'fk_AsignacionListaDetalle_Alumnos1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'asignacionlistadetalle', 'estudiantes'),
('def', 'mydb', 'fk_Bitacora_Usuarios1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'bitacora', 'usuarios'),
('def', 'mydb', 'fk_Carrera_Facultad1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'carrera', 'facultad'),
('def', 'mydb', 'fk_Certificacion_Alumnos1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'certificacion', 'estudiantes'),
('def', 'mydb', 'fk_CertificacionDetalle_Certificacion1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'certificaciondetalle', 'certificacion'),
('def', 'mydb', 'fk_CertificacionDetalle_Curso1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'certificaciondetalle', 'curso'),
('def', 'mydb', 'fk_DetallePensum_Pensum1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'detallepensum', 'pensum'),
('def', 'mydb', 'fk_DetallePensum_Curso1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'detallepensum', 'curso'),
('def', 'mydb', 'fk_Edificio_Facultad1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'edificio', 'facultad'),
('def', 'mydb', 'fk_Edificio_Salon1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'edificio', 'salon'),
('def', 'mydb', 'fk_Laboratorio_Salon1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'laboratorio', 'salon'),
('def', 'mydb', 'fk_Pensum_Jornada1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'pensum', 'jornada'),
('def', 'mydb', 'fk_Pensum_Carrera1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'pensum', 'carrera'),
('def', 'mydb', 'fk_Seccion_Salon1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'seccion', 'salon'),
('def', 'mydb', 'fk_Usuarios_Facultad1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'usuarios', 'facultad'),
('def', 'mydb', 'fk_Usuarios_Tipo1', 'def', 'mydb', 'PRIMARY', 'NONE', 'CASCADE', 'CASCADE', 'usuarios', 'tipo');
...
('def', 'asignacioncursos', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'grupo', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'login', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'mydb', 'utf8', 'utf8_general_ci', NULL),
('def', 'mysql', 'latin1', 'latin1_swedish_ci', NULL),
('def', 'performance_schema', 'utf8', 'utf8_general_ci', NULL),
('def', 'sistemas', 'latin1', 'latin1_swedish_ci', NULL),
...
('INNODB_BUFFER_POOL_READ_AHEAD', '0'),
('INNODB_BUFFER_POOL_READ_AHEAD_EVICTED', '0'),
('INNODB_BUFFER_POOL_READ_REQUESTS', '34946'),
('INNODB_BUFFER_POOL_READS', '174'),
('INNODB_BUFFER_POOL_WAIT_FREE', '0'),
('INNODB_BUFFER_POOL_WRITE_REQUESTS', '9347'),
('INNODB_DATA_FSYNCS', '327'),
...
('THREADS_RUNNING', '1'),
('UPTIME', '11634'),
('UPTIME_SINCE_FLUSH_STATUS', '11634');
...
('def', 'asignacioncursos', 'asignacion', 0, 'asignacioncursos', 'PRIMARY', 1, 'idAsignacion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacion', 1, 'asignacioncursos', 'fk_Asignacion_Alumnos1', 1, 'iIdEstudiantes', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacion', 1, 'asignacioncursos', 'fk_Asignacion_Carrera1', 1, 'iIdCarrera', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacioncurso', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdAsignacionCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacioncurso', 1, 'asignacioncursos', 'fk_AsignacionCurso_Catedratico1', 1, 'iIdCatedratico', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdAsignacionCursoDetalle', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 1, 'asignacioncursos', 'fk_AsignacionCursoDetalle_AsignacionCurso1', 1, 'iIdAsignacionCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 1, 'asignacioncursos', 'fk_AsignacionCursoDetalle_Curso1', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 1, 'asignacioncursos', 'fk_AsignacionCursoDetalle_Jornada1', 1, 'iIdJornada', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 1, 'asignacioncursos', 'fk_AsignacionCursoDetalle_Semestre1', 1, 'iIdSemestre', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 1, 'asignacioncursos', 'fk_AsignacionCursoDetalle_Seccion1', 1, 'iIdSeccion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 1, 'asignacioncursos', 'fk_AsignacionCursoDetalle_Facultad1', 1, 'iIdFacultad', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdAsignacionDetalle', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 1, 'asignacioncursos', 'fk_AsignacionDetalle_Curso1', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 1, 'asignacioncursos', 'fk_AsignacionDetalle_Horario1', 1, 'iIdHorario', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 1, 'asignacioncursos', 'fk_AsignacionDetalle_Seccion1', 1, 'iIdSeccion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 1, 'asignacioncursos', 'fk_AsignacionDetalle_Laboratorio1', 1, 'iIdLaboratorio', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 1, 'asignacioncursos', 'fk_AsignacionDetalle_Semestre1', 1, 'iIdSemestre', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 1, 'asignacioncursos', 'fk_AsignacionDetalle_Asignacion1', 1, 'iIdAsignacion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacionlista', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdAsignacionLista', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacionlista', 1, 'asignacioncursos', 'fk_AsignacionLista_Jornada1', 1, 'iIdJornada', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacionlista', 1, 'asignacioncursos', 'fk_AsignacionLista_Semestre1', 1, 'iIdSemestre', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacionlista', 1, 'asignacioncursos', 'fk_AsignacionLista_Curso1', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacionlista', 1, 'asignacioncursos', 'fk_AsignacionLista_Seccion1', 1, 'iIIdSeccion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacionlista', 1, 'asignacioncursos', 'fk_AsignacionLista_Catedratico1', 1, 'iIdCatedratico', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacionlistadetalle', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdAsignacionListaDetalle', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacionlistadetalle', 1, 'asignacioncursos', 'fk_AsignacionListaDetalle_AsignacionLista1', 1, 'iIdAsignacionLista', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'asignacionlistadetalle', 1, 'asignacioncursos', 'fk_AsignacionListaDetalle_Alumnos1', 1, 'iIdAlumnos', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'bitacora', 0, 'asignacioncursos', 'PRIMARY', 1, 'idBitacora', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'bitacora', 1, 'asignacioncursos', 'fk_Bitacora_Usuarios1', 1, 'iIdUsuarios', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'carrera', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdCarrera', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'carrera', 1, 'asignacioncursos', 'fk_Carrera_Facultad1', 1, 'iIdFacultad', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'catedratico', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdCatedratico', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'certificacion', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdCertificacion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'certificacion', 1, 'asignacioncursos', 'fk_Certificacion_Alumnos1', 1, 'iIdAlumnos', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'certificaciondetalle', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdCertificacionDetalle', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'certificaciondetalle', 1, 'asignacioncursos', 'fk_CertificacionDetalle_Certificacion1', 1, 'iIdCertificacion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'certificaciondetalle', 1, 'asignacioncursos', 'fk_CertificacionDetalle_Curso1', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'curso', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'detallepensum', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdPensum', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'detallepensum', 0, 'asignacioncursos', 'PRIMARY', 2, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'detallepensum', 1, 'asignacioncursos', 'fk_DetallePensum_Curso1', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'edificio', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdEdificio', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'edificio', 1, 'asignacioncursos', 'fk_Edificio_Facultad1', 1, 'iIdFacultad', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'edificio', 1, 'asignacioncursos', 'fk_Edificio_Salon1', 1, 'iIdSalon', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'estudiantes', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdEstudiantes', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'facultad', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdFacultad', 'A', 2, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'horario', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdHorario', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'jornada', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdJornada', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'laboratorio', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdLaboratorio', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'laboratorio', 1, 'asignacioncursos', 'fk_Laboratorio_Salon1', 1, 'iIdSalon', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'pensum', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdPensum', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'pensum', 1, 'asignacioncursos', 'fk_Pensum_Jornada1', 1, 'iIdJornada', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'pensum', 1, 'asignacioncursos', 'fk_Pensum_Carrera1', 1, 'idCarrera', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'salon', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdSalon', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'seccion', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdSeccion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'seccion', 1, 'asignacioncursos', 'fk_Seccion_Salon1', 1, 'iIdSalon', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'semestre', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdSemestre', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'tipo', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdTipo', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'usuarios', 0, 'asignacioncursos', 'PRIMARY', 1, 'iIdUsuarios', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'usuarios', 1, 'asignacioncursos', 'fk_Usuarios_Facultad1', 1, 'iIdFacultad', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'asignacioncursos', 'usuarios', 1, 'asignacioncursos', 'fk_Usuarios_Tipo1', 1, 'iIdTipo', 'A', 3, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacion', 0, 'mydb', 'PRIMARY', 1, 'idAsignacion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacion', 1, 'mydb', 'fk_Asignacion_Alumnos1', 1, 'iIdEstudiantes', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacion', 1, 'mydb', 'fk_Asignacion_Carrera1', 1, 'iIdCarrera', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacioncurso', 0, 'mydb', 'PRIMARY', 1, 'iIdAsignacionCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacioncurso', 1, 'mydb', 'fk_AsignacionCurso_Catedratico1', 1, 'iIdCatedratico', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacioncursodetalle', 0, 'mydb', 'PRIMARY', 1, 'iIdAsignacionCursoDetalle', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacioncursodetalle', 1, 'mydb', 'fk_AsignacionCursoDetalle_AsignacionCurso1', 1, 'iIdAsignacionCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacioncursodetalle', 1, 'mydb', 'fk_AsignacionCursoDetalle_Curso1', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacioncursodetalle', 1, 'mydb', 'fk_AsignacionCursoDetalle_Jornada1', 1, 'iIdJornada', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacioncursodetalle', 1, 'mydb', 'fk_AsignacionCursoDetalle_Semestre1', 1, 'iIdSemestre', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacioncursodetalle', 1, 'mydb', 'fk_AsignacionCursoDetalle_Seccion1', 1, 'iIdSeccion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacioncursodetalle', 1, 'mydb', 'fk_AsignacionCursoDetalle_Facultad1', 1, 'iIdFacultad', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignaciondetalle', 0, 'mydb', 'PRIMARY', 1, 'iIdAsignacionDetalle', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignaciondetalle', 1, 'mydb', 'fk_AsignacionDetalle_Curso1', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignaciondetalle', 1, 'mydb', 'fk_AsignacionDetalle_Horario1', 1, 'iIdHorario', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignaciondetalle', 1, 'mydb', 'fk_AsignacionDetalle_Seccion1', 1, 'iIdSeccion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignaciondetalle', 1, 'mydb', 'fk_AsignacionDetalle_Laboratorio1', 1, 'iIdLaboratorio', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignaciondetalle', 1, 'mydb', 'fk_AsignacionDetalle_Semestre1', 1, 'iIdSemestre', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignaciondetalle', 1, 'mydb', 'fk_AsignacionDetalle_Asignacion1', 1, 'iIdAsignacion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacionlista', 0, 'mydb', 'PRIMARY', 1, 'iIdAsignacionLista', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacionlista', 1, 'mydb', 'fk_AsignacionLista_Jornada1', 1, 'iIdJornada', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacionlista', 1, 'mydb', 'fk_AsignacionLista_Semestre1', 1, 'iIdSemestre', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacionlista', 1, 'mydb', 'fk_AsignacionLista_Curso1', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacionlista', 1, 'mydb', 'fk_AsignacionLista_Seccion1', 1, 'iIIdSeccion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacionlista', 1, 'mydb', 'fk_AsignacionLista_Catedratico1', 1, 'iIdCatedratico', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacionlistadetalle', 0, 'mydb', 'PRIMARY', 1, 'iIdAsignacionListaDetalle', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacionlistadetalle', 1, 'mydb', 'fk_AsignacionListaDetalle_AsignacionLista1', 1, 'iIdAsignacionLista', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'asignacionlistadetalle', 1, 'mydb', 'fk_AsignacionListaDetalle_Alumnos1', 1, 'iIdAlumnos', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'bitacora', 0, 'mydb', 'PRIMARY', 1, 'idBitacora', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'bitacora', 1, 'mydb', 'fk_Bitacora_Usuarios1', 1, 'iIdUsuarios', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'carrera', 0, 'mydb', 'PRIMARY', 1, 'iIdCarrera', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'carrera', 1, 'mydb', 'fk_Carrera_Facultad1', 1, 'iIdFacultad', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'catedratico', 0, 'mydb', 'PRIMARY', 1, 'iIdCatedratico', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'certificacion', 0, 'mydb', 'PRIMARY', 1, 'iIdCertificacion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'certificacion', 1, 'mydb', 'fk_Certificacion_Alumnos1', 1, 'iIdAlumnos', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'certificaciondetalle', 0, 'mydb', 'PRIMARY', 1, 'iIdCertificacionDetalle', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'certificaciondetalle', 1, 'mydb', 'fk_CertificacionDetalle_Certificacion1', 1, 'iIdCertificacion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'certificaciondetalle', 1, 'mydb', 'fk_CertificacionDetalle_Curso1', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'curso', 0, 'mydb', 'PRIMARY', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'detallepensum', 0, 'mydb', 'PRIMARY', 1, 'iIdPensum', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'detallepensum', 0, 'mydb', 'PRIMARY', 2, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'detallepensum', 1, 'mydb', 'fk_DetallePensum_Curso1', 1, 'iIdCurso', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'edificio', 0, 'mydb', 'PRIMARY', 1, 'iIdEdificio', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'edificio', 1, 'mydb', 'fk_Edificio_Facultad1', 1, 'iIdFacultad', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'edificio', 1, 'mydb', 'fk_Edificio_Salon1', 1, 'iIdSalon', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'estudiantes', 0, 'mydb', 'PRIMARY', 1, 'iIdEstudiantes', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'facultad', 0, 'mydb', 'PRIMARY', 1, 'iIdFacultad', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'horario', 0, 'mydb', 'PRIMARY', 1, 'iIdHorario', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'jornada', 0, 'mydb', 'PRIMARY', 1, 'iIdJornada', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'laboratorio', 0, 'mydb', 'PRIMARY', 1, 'iIdLaboratorio', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'laboratorio', 1, 'mydb', 'fk_Laboratorio_Salon1', 1, 'iIdSalon', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'pensum', 0, 'mydb', 'PRIMARY', 1, 'iIdPensum', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'pensum', 1, 'mydb', 'fk_Pensum_Jornada1', 1, 'iIdJornada', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'pensum', 1, 'mydb', 'fk_Pensum_Carrera1', 1, 'idCarrera', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'salon', 0, 'mydb', 'PRIMARY', 1, 'iIdSalon', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'seccion', 0, 'mydb', 'PRIMARY', 1, 'iIdSeccion', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'seccion', 1, 'mydb', 'fk_Seccion_Salon1', 1, 'iIdSalon', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'semestre', 0, 'mydb', 'PRIMARY', 1, 'iIdSemestre', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'tipo', 0, 'mydb', 'PRIMARY', 1, 'iIdTipo', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'usuarios', 0, 'mydb', 'PRIMARY', 1, 'iIdUsuarios', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'usuarios', 1, 'mydb', 'fk_Usuarios_Facultad1', 1, 'iIdFacultad', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
('def', 'mydb', 'usuarios', 1, 'mydb', 'fk_Usuarios_Tipo1', 1, 'iIdTipo', 'A', 0, NULL, NULL, '', 'BTREE', '', ''),
...
('def', 'information_schema', 'CHARACTER_SETS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 384, 0, 16434816, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=43690', ''),
('def', 'information_schema', 'COLLATIONS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 231, 0, 16704765, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=72628', ''),
('def', 'information_schema', 'COLLATION_CHARACTER_SET_APPLICABILITY', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 195, 0, 16357770, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=86037', ''),
('def', 'information_schema', 'COLUMNS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-07-29 01:40:58', '2019-07-29 01:40:58', NULL, 'utf8_general_ci', NULL, 'max_rows=2802', ''),
('def', 'information_schema', 'COLUMN_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2565, 0, 16757145, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6540', ''),
('def', 'information_schema', 'ENGINES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 490, 0, 16574250, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=34239', ''),
('def', 'information_schema', 'EVENTS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-07-29 01:40:58', '2019-07-29 01:40:58', NULL, 'utf8_general_ci', NULL, 'max_rows=618', ''),
('def', 'information_schema', 'FILES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2677, 0, 16758020, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6267', ''),
('def', 'information_schema', 'GLOBAL_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'GLOBAL_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'KEY_COLUMN_USAGE', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4637, 0, 16762755, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3618', ''),
('def', 'information_schema', 'PARAMETERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-07-29 01:40:58', '2019-07-29 01:40:58', NULL, 'utf8_general_ci', NULL, 'max_rows=6050', ''),
('def', 'information_schema', 'PARTITIONS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-07-29 01:40:58', '2019-07-29 01:40:58', NULL, 'utf8_general_ci', NULL, 'max_rows=5579', ''),
('def', 'information_schema', 'PLUGINS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-07-29 01:40:58', '2019-07-29 01:40:58', NULL, 'utf8_general_ci', NULL, 'max_rows=11328', ''),
('def', 'information_schema', 'PROCESSLIST', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-07-29 01:40:58', '2019-07-29 01:40:58', NULL, 'utf8_general_ci', NULL, 'max_rows=23899', ''),
('def', 'information_schema', 'PROFILING', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 308, 0, 16562084, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=54471', ''),
('def', 'information_schema', 'REFERENTIAL_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4814, 0, 16767162, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3485', ''),
('def', 'information_schema', 'ROUTINES', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-07-29 01:40:58', '2019-07-29 01:40:58', NULL, 'utf8_general_ci', NULL, 'max_rows=583', ''),
('def', 'information_schema', 'SCHEMATA', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3464, 0, 16738048, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=4843', ''),
('def', 'information_schema', 'SCHEMA_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2179, 0, 16736899, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7699', ''),
('def', 'information_schema', 'SESSION_STATUS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'SESSION_VARIABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 3268, 0, 16755036, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=5133', ''),
('def', 'information_schema', 'STATISTICS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 5753, 0, 16752736, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2916', ''),
('def', 'information_schema', 'TABLES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 9450, 0, 16764300, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=1775', ''),
('def', 'information_schema', 'TABLESPACES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 6951, 0, 16772763, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=2413', ''),
('def', 'information_schema', 'TABLE_CONSTRAINTS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2504, 0, 16721712, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=6700', ''),
('def', 'information_schema', 'TABLE_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 2372, 0, 16748692, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=7073', ''),
('def', 'information_schema', 'TRIGGERS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-07-29 01:40:58', '2019-07-29 01:40:58', NULL, 'utf8_general_ci', NULL, 'max_rows=569', ''),
('def', 'information_schema', 'USER_PRIVILEGES', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 1986, 0, 16726092, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=8447', ''),
('def', 'information_schema', 'VIEWS', 'SYSTEM VIEW', 'MyISAM', 10, 'Dynamic', NULL, 0, 0, 281474976710655, 1024, 0, NULL, '2019-07-29 01:40:58', '2019-07-29 01:40:58', NULL, 'utf8_general_ci', NULL, 'max_rows=6935', ''),
('def', 'information_schema', 'INNODB_CMP_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_TRX', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 4534, 0, 16766732, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=3700', ''),
('def', 'information_schema', 'INNODB_CMPMEM_RESET', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_LOCK_WAITS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 599, 0, 16749238, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=28008', ''),
('def', 'information_schema', 'INNODB_CMPMEM', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 29, 0, 15204352, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=578524', ''),
('def', 'information_schema', 'INNODB_CMP', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 25, 0, 13107200, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=671088', ''),
('def', 'information_schema', 'INNODB_LOCKS', 'SYSTEM VIEW', 'MEMORY', 10, 'Fixed', NULL, 31244, 0, 16746784, 0, 0, NULL, '2019-07-29 01:40:58', NULL, NULL, 'utf8_general_ci', NULL, 'max_rows=536', ''),
('def', 'asignacioncursos', 'asignacion', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:35:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'asignacioncurso', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:36:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'asignacioncursodetalle', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 98304, 5242880, NULL, '2019-07-29 01:36:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'asignaciondetalle', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 98304, 5242880, NULL, '2019-07-29 01:35:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'asignacionlista', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 81920, 5242880, NULL, '2019-07-29 01:35:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'asignacionlistadetalle', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:35:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'bitacora', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:36:01', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'carrera', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:35:57', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'catedratico', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:35:59', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'certificacion', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:36:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'certificaciondetalle', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:36:00', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'curso', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:35:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'detallepensum', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:35:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'edificio', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:35:57', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'estudiantes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:35:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'facultad', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:35:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'horario', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:35:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'jornada', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:35:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'laboratorio', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:35:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'pensum', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:35:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'salon', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:35:57', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'seccion', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:35:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'semestre', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:35:58', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'tipo', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:35:56', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'asignacioncursos', 'usuarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:35:57', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'grupo', 'usuarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 2, 8192, 16384, 0, 0, 5242880, NULL, '2019-05-24 00:15:45', NULL, NULL, 'latin1_swedish_ci', NULL, '', ''),
('def', 'mydb', 'asignacion', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:29:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'asignacioncurso', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:29:57', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'asignacioncursodetalle', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 98304, 5242880, NULL, '2019-07-29 01:29:57', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'asignaciondetalle', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 98304, 5242880, NULL, '2019-07-29 01:29:56', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'asignacionlista', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 81920, 5242880, NULL, '2019-07-29 01:29:56', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'asignacionlistadetalle', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:29:57', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'bitacora', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:29:57', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'carrera', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:29:54', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'catedratico', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:29:56', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'certificacion', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:29:57', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'certificaciondetalle', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:29:57', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'curso', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:29:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'detallepensum', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:29:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'edificio', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:29:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'estudiantes', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:29:54', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'facultad', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:29:54', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'horario', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:29:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'jornada', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:29:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'laboratorio', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:29:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'pensum', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:29:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'salon', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:29:54', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'seccion', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 16384, 5242880, NULL, '2019-07-29 01:29:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'semestre', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:29:55', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'tipo', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 0, 5242880, NULL, '2019-07-29 01:29:54', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
('def', 'mydb', 'usuarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 0, 0, 16384, 0, 32768, 5242880, NULL, '2019-07-29 01:29:54', NULL, NULL, 'utf8_general_ci', NULL, '', ''),
...
('def', 'sistemas', 'usuarios', 'BASE TABLE', 'InnoDB', 10, 'Compact', 3, 5461, 16384, 0, 0, 5242880, NULL, '2019-05-22 02:58:11', NULL, NULL, 'latin1_swedish_ci', NULL, '', '');
...
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'asignacion', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_Asignacion_Alumnos1', 'asignacioncursos', 'asignacion', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_Asignacion_Carrera1', 'asignacioncursos', 'asignacion', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'asignacioncurso', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_AsignacionCurso_Catedratico1', 'asignacioncursos', 'asignacioncurso', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'asignacioncursodetalle', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_AsignacionCurso1', 'asignacioncursos', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Curso1', 'asignacioncursos', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Jornada1', 'asignacioncursos', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Semestre1', 'asignacioncursos', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Seccion1', 'asignacioncursos', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionCursoDetalle_Facultad1', 'asignacioncursos', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'asignaciondetalle', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Curso1', 'asignacioncursos', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Horario1', 'asignacioncursos', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Seccion1', 'asignacioncursos', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Laboratorio1', 'asignacioncursos', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Semestre1', 'asignacioncursos', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionDetalle_Asignacion1', 'asignacioncursos', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'asignacionlista', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Jornada1', 'asignacioncursos', 'asignacionlista', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Semestre1', 'asignacioncursos', 'asignacionlista', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Curso1', 'asignacioncursos', 'asignacionlista', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Seccion1', 'asignacioncursos', 'asignacionlista', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionLista_Catedratico1', 'asignacioncursos', 'asignacionlista', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'asignacionlistadetalle', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_AsignacionListaDetalle_AsignacionLista1', 'asignacioncursos', 'asignacionlistadetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_AsignacionListaDetalle_Alumnos1', 'asignacioncursos', 'asignacionlistadetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'bitacora', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_Bitacora_Usuarios1', 'asignacioncursos', 'bitacora', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'carrera', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_Carrera_Facultad1', 'asignacioncursos', 'carrera', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'catedratico', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'certificacion', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_Certificacion_Alumnos1', 'asignacioncursos', 'certificacion', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'certificaciondetalle', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_CertificacionDetalle_Certificacion1', 'asignacioncursos', 'certificaciondetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_CertificacionDetalle_Curso1', 'asignacioncursos', 'certificaciondetalle', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'curso', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'detallepensum', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_DetallePensum_Pensum1', 'asignacioncursos', 'detallepensum', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_DetallePensum_Curso1', 'asignacioncursos', 'detallepensum', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'edificio', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_Edificio_Facultad1', 'asignacioncursos', 'edificio', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_Edificio_Salon1', 'asignacioncursos', 'edificio', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'estudiantes', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'facultad', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'horario', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'jornada', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'laboratorio', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_Laboratorio_Salon1', 'asignacioncursos', 'laboratorio', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'pensum', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_Pensum_Jornada1', 'asignacioncursos', 'pensum', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_Pensum_Carrera1', 'asignacioncursos', 'pensum', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'salon', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'seccion', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_Seccion_Salon1', 'asignacioncursos', 'seccion', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'semestre', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'tipo', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'PRIMARY', 'asignacioncursos', 'usuarios', 'PRIMARY KEY'),
('def', 'asignacioncursos', 'fk_Usuarios_Facultad1', 'asignacioncursos', 'usuarios', 'FOREIGN KEY'),
('def', 'asignacioncursos', 'fk_Usuarios_Tipo1', 'asignacioncursos', 'usuarios', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'asignacion', 'PRIMARY KEY'),
('def', 'mydb', 'fk_Asignacion_Alumnos1', 'mydb', 'asignacion', 'FOREIGN KEY'),
('def', 'mydb', 'fk_Asignacion_Carrera1', 'mydb', 'asignacion', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'asignacioncurso', 'PRIMARY KEY'),
('def', 'mydb', 'fk_AsignacionCurso_Catedratico1', 'mydb', 'asignacioncurso', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'asignacioncursodetalle', 'PRIMARY KEY'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_AsignacionCurso1', 'mydb', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Curso1', 'mydb', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Jornada1', 'mydb', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Semestre1', 'mydb', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Seccion1', 'mydb', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionCursoDetalle_Facultad1', 'mydb', 'asignacioncursodetalle', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'asignaciondetalle', 'PRIMARY KEY'),
('def', 'mydb', 'fk_AsignacionDetalle_Curso1', 'mydb', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionDetalle_Horario1', 'mydb', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionDetalle_Seccion1', 'mydb', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionDetalle_Laboratorio1', 'mydb', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionDetalle_Semestre1', 'mydb', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionDetalle_Asignacion1', 'mydb', 'asignaciondetalle', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'asignacionlista', 'PRIMARY KEY'),
('def', 'mydb', 'fk_AsignacionLista_Jornada1', 'mydb', 'asignacionlista', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionLista_Semestre1', 'mydb', 'asignacionlista', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionLista_Curso1', 'mydb', 'asignacionlista', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionLista_Seccion1', 'mydb', 'asignacionlista', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionLista_Catedratico1', 'mydb', 'asignacionlista', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'asignacionlistadetalle', 'PRIMARY KEY'),
('def', 'mydb', 'fk_AsignacionListaDetalle_AsignacionLista1', 'mydb', 'asignacionlistadetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_AsignacionListaDetalle_Alumnos1', 'mydb', 'asignacionlistadetalle', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'bitacora', 'PRIMARY KEY'),
('def', 'mydb', 'fk_Bitacora_Usuarios1', 'mydb', 'bitacora', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'carrera', 'PRIMARY KEY'),
('def', 'mydb', 'fk_Carrera_Facultad1', 'mydb', 'carrera', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'catedratico', 'PRIMARY KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'certificacion', 'PRIMARY KEY'),
('def', 'mydb', 'fk_Certificacion_Alumnos1', 'mydb', 'certificacion', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'certificaciondetalle', 'PRIMARY KEY'),
('def', 'mydb', 'fk_CertificacionDetalle_Certificacion1', 'mydb', 'certificaciondetalle', 'FOREIGN KEY'),
('def', 'mydb', 'fk_CertificacionDetalle_Curso1', 'mydb', 'certificaciondetalle', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'curso', 'PRIMARY KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'detallepensum', 'PRIMARY KEY'),
('def', 'mydb', 'fk_DetallePensum_Pensum1', 'mydb', 'detallepensum', 'FOREIGN KEY'),
('def', 'mydb', 'fk_DetallePensum_Curso1', 'mydb', 'detallepensum', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'edificio', 'PRIMARY KEY'),
('def', 'mydb', 'fk_Edificio_Facultad1', 'mydb', 'edificio', 'FOREIGN KEY'),
('def', 'mydb', 'fk_Edificio_Salon1', 'mydb', 'edificio', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'estudiantes', 'PRIMARY KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'facultad', 'PRIMARY KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'horario', 'PRIMARY KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'jornada', 'PRIMARY KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'laboratorio', 'PRIMARY KEY'),
('def', 'mydb', 'fk_Laboratorio_Salon1', 'mydb', 'laboratorio', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'pensum', 'PRIMARY KEY'),
('def', 'mydb', 'fk_Pensum_Jornada1', 'mydb', 'pensum', 'FOREIGN KEY'),
('def', 'mydb', 'fk_Pensum_Carrera1', 'mydb', 'pensum', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'salon', 'PRIMARY KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'seccion', 'PRIMARY KEY'),
('def', 'mydb', 'fk_Seccion_Salon1', 'mydb', 'seccion', 'FOREIGN KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'semestre', 'PRIMARY KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'tipo', 'PRIMARY KEY'),
('def', 'mydb', 'PRIMARY', 'mydb', 'usuarios', 'PRIMARY KEY'),
('def', 'mydb', 'fk_Usuarios_Facultad1', 'mydb', 'usuarios', 'FOREIGN KEY'),
('def', 'mydb', 'fk_Usuarios_Tipo1', 'mydb', 'usuarios', 'FOREIGN KEY'),
...
--
CREATE DATABASE `sistemas` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `sistemas`;
